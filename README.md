...
| ![Image](https://github.com/jbruce12000/kiln-controller/blob/main/public/assets/images/ks-1018.png) | Electric Kiln | On trouve encore beaucoup de vieux fours électriques sans commande numérique. On peut en dénicher un d'occasion à petit prix. Ce contrôleur fonctionne en 110 V ou 220 V (choisissez un relais statique adapté). Mon four est un Skutt KS-1018. |
